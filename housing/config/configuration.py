...
class Configuration:
    ...
    def get_data_ingestion_config(self)->DataIngestionConfig:
        try:
            ...
            return DataIngestionConfig(dataset_download_url=dataset_download_url, 
    ...
    def get_training_pipeline_config(self) -> TrainingPipelineConfig:
        try:
            ...
            artifact_dir=training_pipeline_info[TRAINING_PIPELINE_ARTIFACT_DIR_KEY]
            artifact_dir=os.path.join(ROOT_DIR,pipeline_name,artifact_dir)
